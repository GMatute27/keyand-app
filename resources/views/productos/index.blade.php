...
<a href="{{route('productos.create')}}">Crear un producto nuevo</a>
    <table class="table table-dark">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{$prod->Nombrec}}</td>
                <td>
                    <img src="{{asset('storage'.'/'.$prod->imagen)}}" alt="">
                </td>
                <td>{{$prod->codproducto}}</td>
                <td>{{$prod->tallas}}</td>
                <td>
                <a href="{{url( '/productos/'.$prod->idp.'/edit' )}}"> 
                    Modificar
                </a>
                    
                    
                <form action="{{url( '/productos/'.$prod->idp )}}" method="post">
                @csrf
                {{method_field('DELETE')}}
